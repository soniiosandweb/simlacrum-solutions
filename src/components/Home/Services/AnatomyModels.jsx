...
const AnatomyModels = () => {
    ...
    return(
        <section className="home-AnatomyModels pb-20" id="anatomy_models">
            <div className='relative bg-primary-bg'>
                <div className="flex flex-col lg:flex-row gap-5 w-full max-w-6xl mx-auto items-center px-3 py-10 md:py-20">
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col gap-5 items-start z-10">
                        <h3 className="text-3xl md:text-5xl bg-gradient-to-r from-primary-blue to-primary-darkBlue font-semibold text-gradient">Anatomy Models</h3>
                        <p className='text-base md:text-lg opacity-60'>Anatomy models are physical or digital representations of the human body or its parts. These models serve as essential tools for teaching and learning in medical and healthcare education, offering a tangible understanding of anatomical structures.</p>

...
const InSituSimulations = () => {
    ...
    return(
        <section className="home-InSituSimulations pb-20" id="insitu_simulations">
            <div className='relative bg-primary-bg'>
                <div className="flex flex-col lg:flex-row gap-5 w-full max-w-6xl mx-auto items-center px-3 py-10 md:py-20">
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col gap-5 items-start z-10">
                        <h3 className="text-3xl md:text-5xl bg-gradient-to-r from-primary-blue to-primary-darkBlue font-semibold text-gradient">In Situ Simulations</h3>
                        <p className='text-base md:text-lg opacity-60'>In situ simulations are conducted in the actual clinical environment where healthcare providers work. These simulations help identify system issues, enhance team communication, and improve patient safety by practicing real-life scenarios in the real-world setting.</p>

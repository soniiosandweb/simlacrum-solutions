...
const SimulationEquipment = () => {
    ...
    return(
        <section className="home-SimulationEquipment py-10 md:py-20">
            <div className='relative bg-primary-grey'>
                <div className="flex flex-col lg:flex-row gap-5 w-full max-w-6xl mx-auto items-center pr-3 pl-3 lg:pl-0 lg:pr-10 py-10 md:py-20">
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col gap-5 items-start z-10">
                        <h3 className="text-5xl bg-gradient-to-r from-primary-blue to-primary-darkBlue font-semibold text-gradient">Simulation Equipment</h3>
                        <p className='text-lg opacity-60 text-white'>We provide a wide range of high-quality simulation equipment designed to meet the diverse needs of healthcare training programs. From manikins and task trainers to advanced diagnostic tools, our equipment ensures realistic and effective training experiences.</p>
                        <Link to="#" className='bg-primary-darkBlue text-white py-3 px-6 text-md hover:bg-primary-blue'>Explore Our Solutions</Link>
                        <p className='text-primary-textLight font-archivo text-150 opacity-10 absolute left-8 top-0 lg:top-auto bottom-auto lg:bottom-0 -z-10'>04</p>
                    </div>

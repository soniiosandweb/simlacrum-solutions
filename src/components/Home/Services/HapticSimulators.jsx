            ...
            <div className='relative bg-primary-bg'>
                <div className="flex flex-col lg:flex-row gap-5 w-full max-w-6xl mx-auto items-center pr-3 pl-3 lg:pl-0 lg:pr-10 py-10 md:py-20">
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col gap-5 items-start z-10">
                        <h3 className="text-5xl bg-gradient-to-r from-primary-blue to-primary-darkBlue font-semibold text-gradient">Haptic Simulators</h3>
                        <p className='text-lg opacity-60'>Haptic simulators use advanced technology to provide tactile feedback during simulated procedures. These simulators enhance the learning experience by allowing users to feel the resistance and texture of tissues, improving their manual skills and dexterity.</p>

...
const DentalSimulator = () => {
    ...
    return(
        <section className="home-DentalSimulator py-10 md:py-20">
            <div className='relative bg-primary-bg'>
                <div className="flex flex-col lg:flex-row gap-5 w-full max-w-6xl mx-auto items-center pr-3 pl-3 lg:pl-0 lg:pr-10 py-10 md:py-20">
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col gap-5 items-start z-10">
                        <h3 className="text-5xl bg-gradient-to-r from-primary-blue to-primary-darkBlue font-semibold text-gradient">Dental Simulator</h3>
                        <p className='text-lg opacity-60'>Dental simulators are cutting-edge training tools designed to replicate real-life clinical scenarios for dental students and professionals. These simulators offer a safe and controlled environment to practice and refine skills, ensuring that learners gain confidence and proficiency before treating actual patients.</p>

        ...
        <section className="home-about-section py-10 md:py-20">
            ...
            <div className="flex flex-col lg:flex-row gap-5 w-full mx-auto items-center px-3 lg:px-10">
                <div className="w-full lg:w-3/5">
                    <h2 className="text-4xl font-medium">Simlacruminc Solutions is at the forefront of <span className="text-primary-darkBlue font-semibold">revolutionising clinical training</span> through state-of-the-art <span className="text-primary-darkBlue font-semibold">simulation technology</span>.</h2>
                </div>

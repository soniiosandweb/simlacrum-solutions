...
const GetInTouch = () => {
    return(
        <section className="home-getintouch-section py-20">
            <div className='flex flex-col md:flex-row max-w-6xl mx-auto px-3 bg-primary-grey'>
                <div className="w-full md:w-1/2 py-10 px-3 sm:px-5 md:px-10 flex flex-col gap-5 text-left justify-center items-start">
                    <h3 className="text-xl md:text-3xl md:text-5xl bg-gradient-to-r from-primary-darkBlue to-primary-blue font-semibold text-gradient">Do you have any question ?</h3>
